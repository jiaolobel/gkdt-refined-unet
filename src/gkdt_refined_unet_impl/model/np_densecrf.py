...
from .bilateral_step_factory import BilateralStep
from .spatial_step_factory import SpatialStep
...
class DenseCRF(DenseCRFBase):
    ...
    def mean_field_approximation(
        ...
        for i in range(self.config.num_iterations):
            ...
            bilateral_out = bilateral_step.compute(Q)

            # - Symmetric normalization and spatial message passing
            spatial_out = spatial_step.compute(Q)
