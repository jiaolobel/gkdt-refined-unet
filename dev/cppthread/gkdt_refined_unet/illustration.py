...
for num in [config.n_thread, ]:
    in_path = "E:/Research/experiment_results/efficient_glob_perm_rfn_unet/iiki2025/{}/l8/0/{}/a=80.0, b=0.03125, r=3.0".format(config.version, num)  # Perm. RFN. UNet w/o 
    image_path = "E:/Research/experiment_data/l8/false/"
    out_path = "visual/jpg/{}/{}".format(config.version, num)
