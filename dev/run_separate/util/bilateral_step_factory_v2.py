...
class BilateralStep:
    ...
    def init(self, image: tf.Tensor, theta_alpha, theta_beta):
        ...
        print("To initialize PyGKDTFilter")

        self.gkdt_filter = PyGKDTFilter(pos, n_imchannels + 2, h * w)

    def filter(self, value: tf.Tensor):
