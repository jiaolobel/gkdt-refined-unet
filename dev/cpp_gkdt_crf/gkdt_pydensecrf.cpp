...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "language": "c++",
        "name": "gkdt_pydensecrf",
        "sources": [
            "gkdt_pydensecrf.pyx"
        ]
    },
    "module_name": "gkdt_pydensecrf"
}
END: Cython Metadata */
...
#define __PYX_HAVE__gkdt_pydensecrf
#define __PYX_HAVE_API__gkdt_pydensecrf
/* Early includes */
#include "ios"
#include "new"
#include "stdexcept"
#include "typeinfo"
#include "gkdt_densecrf.h"
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
#include <stdio.h>
...
/*--- Type declarations ---*/
struct __pyx_obj_15gkdt_pydensecrf_PyDenseCRF;
struct __pyx_array_obj;
struct __pyx_MemviewEnum_obj;
struct __pyx_memoryview_obj;
struct __pyx_memoryviewslice_obj;

/* "gkdt_pydensecrf.pyx":21
 * 
 * 
...
/* Module declarations from 'gkdt_pydensecrf' */
static PyTypeObject *__pyx_ptype_15gkdt_pydensecrf_PyDenseCRF = 0;
...
#define __Pyx_MODULE_NAME "gkdt_pydensecrf"
extern int __pyx_module_is_main_gkdt_pydensecrf;
int __pyx_module_is_main_gkdt_pydensecrf = 0;

/* Implementation of 'gkdt_pydensecrf' */
...
static const char __pyx_k_unary1[] = "unary1";
...
static const char __pyx_k_d_bifeats[] = "d_bifeats";
static const char __pyx_k_d_spfeats[] = "d_spfeats";
static const char __pyx_k_enumerate[] = "enumerate";
static const char __pyx_k_n_classes[] = "n_classes";
static const char __pyx_k_pyx_state[] = "__pyx_state";
static const char __pyx_k_reduce_ex[] = "__reduce_ex__";
static const char __pyx_k_IndexError[] = "IndexError";
static const char __pyx_k_PyDenseCRF[] = "PyDenseCRF";
static const char __pyx_k_ValueError[] = "ValueError";
static const char __pyx_k_pyx_result[] = "__pyx_result";
static const char __pyx_k_pyx_vtable[] = "__pyx_vtable__";
static const char __pyx_k_theta_beta[] = "theta_beta";
static const char __pyx_k_MemoryError[] = "MemoryError";
static const char __pyx_k_PickleError[] = "PickleError";
static const char __pyx_k_theta_alpha[] = "theta_alpha";
static const char __pyx_k_theta_gamma[] = "theta_gamma";
static const char __pyx_k_n_iterations[] = "n_iterations";
static const char __pyx_k_pyx_checksum[] = "__pyx_checksum";
static const char __pyx_k_stringsource[] = "stringsource";
static const char __pyx_k_pyx_getbuffer[] = "__pyx_getbuffer";
static const char __pyx_k_reduce_cython[] = "__reduce_cython__";
static const char __pyx_k_spatial_compat[] = "spatial_compat";
static const char __pyx_k_View_MemoryView[] = "View.MemoryView";
static const char __pyx_k_allocate_buffer[] = "allocate_buffer";
static const char __pyx_k_dtype_is_object[] = "dtype_is_object";
static const char __pyx_k_pyx_PickleError[] = "__pyx_PickleError";
static const char __pyx_k_setstate_cython[] = "__setstate_cython__";
static const char __pyx_k_bilateral_compat[] = "bilateral_compat";
...
static PyObject *__pyx_n_s_PyDenseCRF;
...
static PyObject *__pyx_n_s_bilateral_compat;
...
static PyObject *__pyx_n_s_d_bifeats;
static PyObject *__pyx_n_s_d_spfeats;
...
static PyObject *__pyx_n_s_spatial_compat;
...
static PyObject *__pyx_n_s_theta_alpha;
static PyObject *__pyx_n_s_theta_beta;
static PyObject *__pyx_n_s_theta_gamma;
static PyObject *__pyx_kp_s_unable_to_allocate_array_data;
static PyObject *__pyx_kp_s_unable_to_allocate_shape_and_str;
static PyObject *__pyx_n_s_unary1;
static PyObject *__pyx_n_s_unpack;
static PyObject *__pyx_n_s_update;
static int __pyx_pf_15gkdt_pydensecrf_10PyDenseCRF___cinit__(struct __pyx_obj_15gkdt_pydensecrf_PyDenseCRF *__pyx_v_self, int __pyx_v_H, int __pyx_v_W, int __pyx_v_n_classes, int __pyx_v_d_bifeats, int __pyx_v_d_spfeats, float __pyx_v_theta_alpha, float __pyx_v_theta_beta, float __pyx_v_theta_gamma, float __pyx_v_bilateral_compat, float __pyx_v_spatial_compat, int __pyx_v_n_iterations); /* proto */
static PyObject *__pyx_pf_15gkdt_pydensecrf_10PyDenseCRF_2inference(struct __pyx_obj_15gkdt_pydensecrf_PyDenseCRF *__pyx_v_self, __Pyx_memviewslice __pyx_v_unary1, __Pyx_memviewslice __pyx_v_ref, __Pyx_memviewslice __pyx_v_out1); /* proto */
static void __pyx_pf_15gkdt_pydensecrf_10PyDenseCRF_4__dealloc__(struct __pyx_obj_15gkdt_pydensecrf_PyDenseCRF *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_15gkdt_pydensecrf_10PyDenseCRF_6__reduce_cython__(CYTHON_UNUSED struct __pyx_obj_15gkdt_pydensecrf_PyDenseCRF *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_15gkdt_pydensecrf_10PyDenseCRF_8__setstate_cython__(CYTHON_UNUSED struct __pyx_obj_15gkdt_pydensecrf_PyDenseCRF *__pyx_v_self, CYTHON_UNUSED PyObject *__pyx_v___pyx_state); /* proto */
...
static PyObject *__pyx_tp_new_15gkdt_pydensecrf_PyDenseCRF(PyTypeObject *t, PyObject *a, PyObject *k); /*proto*/
...
/* Python wrapper */
static int __pyx_pw_15gkdt_pydensecrf_10PyDenseCRF_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static int __pyx_pw_15gkdt_pydensecrf_10PyDenseCRF_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_v_H;
  int __pyx_v_W;
  int __pyx_v_n_classes;
  int __pyx_v_d_bifeats;
  int __pyx_v_d_spfeats;
  float __pyx_v_theta_alpha;
  float __pyx_v_theta_beta;
  float __pyx_v_theta_gamma;
  float __pyx_v_bilateral_compat;
  float __pyx_v_spatial_compat;
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_H,&__pyx_n_s_W,&__pyx_n_s_n_classes,&__pyx_n_s_d_bifeats,&__pyx_n_s_d_spfeats,&__pyx_n_s_theta_alpha,&__pyx_n_s_theta_beta,&__pyx_n_s_theta_gamma,&__pyx_n_s_bilateral_compat,&__pyx_n_s_spatial_compat,&__pyx_n_s_n_iterations,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_W)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("__cinit__", 1, 11, 11, 1); __PYX_ERR(1, 24, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_n_classes)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("__cinit__", 1, 11, 11, 2); __PYX_ERR(1, 24, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_d_bifeats)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("__cinit__", 1, 11, 11, 3); __PYX_ERR(1, 24, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_d_spfeats)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("__cinit__", 1, 11, 11, 4); __PYX_ERR(1, 24, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_theta_alpha)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("__cinit__", 1, 11, 11, 5); __PYX_ERR(1, 24, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_theta_beta)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("__cinit__", 1, 11, 11, 6); __PYX_ERR(1, 24, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  7:
        if (likely((values[7] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_theta_gamma)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("__cinit__", 1, 11, 11, 7); __PYX_ERR(1, 24, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  8:
        if (likely((values[8] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_bilateral_compat)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("__cinit__", 1, 11, 11, 8); __PYX_ERR(1, 24, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  9:
        if (likely((values[9] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_spatial_compat)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("__cinit__", 1, 11, 11, 9); __PYX_ERR(1, 24, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 10:
        if (likely((values[10] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_n_iterations)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("__cinit__", 1, 11, 11, 10); __PYX_ERR(1, 24, __pyx_L3_error)
        }
      }
    ...
    __pyx_v_H = __Pyx_PyInt_As_int(values[0]); if (unlikely((__pyx_v_H == (int)-1) && PyErr_Occurred())) __PYX_ERR(1, 25, __pyx_L3_error)
    __pyx_v_W = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_W == (int)-1) && PyErr_Occurred())) __PYX_ERR(1, 25, __pyx_L3_error)
    __pyx_v_n_classes = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_n_classes == (int)-1) && PyErr_Occurred())) __PYX_ERR(1, 25, __pyx_L3_error)
    __pyx_v_d_bifeats = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_d_bifeats == (int)-1) && PyErr_Occurred())) __PYX_ERR(1, 26, __pyx_L3_error)
    __pyx_v_d_spfeats = __Pyx_PyInt_As_int(values[4]); if (unlikely((__pyx_v_d_spfeats == (int)-1) && PyErr_Occurred())) __PYX_ERR(1, 26, __pyx_L3_error)
    __pyx_v_theta_alpha = __pyx_PyFloat_AsFloat(values[5]); if (unlikely((__pyx_v_theta_alpha == (float)-1) && PyErr_Occurred())) __PYX_ERR(1, 27, __pyx_L3_error)
    __pyx_v_theta_beta = __pyx_PyFloat_AsFloat(values[6]); if (unlikely((__pyx_v_theta_beta == (float)-1) && PyErr_Occurred())) __PYX_ERR(1, 27, __pyx_L3_error)
    __pyx_v_theta_gamma = __pyx_PyFloat_AsFloat(values[7]); if (unlikely((__pyx_v_theta_gamma == (float)-1) && PyErr_Occurred())) __PYX_ERR(1, 28, __pyx_L3_error)
    __pyx_v_bilateral_compat = __pyx_PyFloat_AsFloat(values[8]); if (unlikely((__pyx_v_bilateral_compat == (float)-1) && PyErr_Occurred())) __PYX_ERR(1, 29, __pyx_L3_error)
    __pyx_v_spatial_compat = __pyx_PyFloat_AsFloat(values[9]); if (unlikely((__pyx_v_spatial_compat == (float)-1) && PyErr_Occurred())) __PYX_ERR(1, 29, __pyx_L3_error)
    __pyx_v_n_iterations = __Pyx_PyInt_As_int(values[10]); if (unlikely((__pyx_v_n_iterations == (int)-1) && PyErr_Occurred())) __PYX_ERR(1, 30, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("__cinit__", 1, 11, 11, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(1, 24, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("gkdt_pydensecrf.PyDenseCRF.__cinit__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return -1;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_15gkdt_pydensecrf_10PyDenseCRF___cinit__(((struct __pyx_obj_15gkdt_pydensecrf_PyDenseCRF *)__pyx_v_self), __pyx_v_H, __pyx_v_W, __pyx_v_n_classes, __pyx_v_d_bifeats, __pyx_v_d_spfeats, __pyx_v_theta_alpha, __pyx_v_theta_beta, __pyx_v_theta_gamma, __pyx_v_bilateral_compat, __pyx_v_spatial_compat, __pyx_v_n_iterations);
...
static int __pyx_pf_15gkdt_pydensecrf_10PyDenseCRF___cinit__(struct __pyx_obj_15gkdt_pydensecrf_PyDenseCRF *__pyx_v_self, int __pyx_v_H, int __pyx_v_W, int __pyx_v_n_classes, int __pyx_v_d_bifeats, int __pyx_v_d_spfeats, float __pyx_v_theta_alpha, float __pyx_v_theta_beta, float __pyx_v_theta_gamma, float __pyx_v_bilateral_compat, float __pyx_v_spatial_compat, int __pyx_v_n_iterations) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  DenseCRF *__pyx_t_1;
  int __pyx_lineno = 0;
 ...
 */
  try {
    __pyx_t_1 = new DenseCRF(__pyx_v_H, __pyx_v_W, __pyx_v_n_classes, __pyx_v_d_bifeats, __pyx_v_d_spfeats, __pyx_v_theta_alpha, __pyx_v_theta_beta, __pyx_v_theta_gamma, __pyx_v_bilateral_compat, __pyx_v_spatial_compat, __pyx_v_n_iterations);
  } catch(...) {
    __Pyx_CppExn2PyErr();
    __PYX_ERR(1, 32, __pyx_L1_error)
  }
  __pyx_v_self->dcrf = __pyx_t_1;
...
/* Python wrapper */
static PyObject *__pyx_pw_15gkdt_pydensecrf_10PyDenseCRF_3inference(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_15gkdt_pydensecrf_10PyDenseCRF_3inference(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_unary1 = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_ref = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_out1 = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_unary1,&__pyx_n_s_ref,&__pyx_n_s_out1,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_unary1)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ref)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("inference", 1, 3, 3, 1); __PYX_ERR(1, 41, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_out1)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("inference", 1, 3, 3, 2); __PYX_ERR(1, 41, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "inference") < 0)) __PYX_ERR(1, 41, __pyx_L3_error)
      }
    ...
    __pyx_v_unary1 = __Pyx_PyObject_to_MemoryviewSlice_ds_float(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_unary1.memview)) __PYX_ERR(1, 41, __pyx_L3_error)
    __pyx_v_ref = __Pyx_PyObject_to_MemoryviewSlice_ds_float(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_ref.memview)) __PYX_ERR(1, 41, __pyx_L3_error)
    __pyx_v_out1 = __Pyx_PyObject_to_MemoryviewSlice_ds_float(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_out1.memview)) __PYX_ERR(1, 41, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("inference", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(1, 41, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("gkdt_pydensecrf.PyDenseCRF.inference", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_15gkdt_pydensecrf_10PyDenseCRF_2inference(((struct __pyx_obj_15gkdt_pydensecrf_PyDenseCRF *)__pyx_v_self), __pyx_v_unary1, __pyx_v_ref, __pyx_v_out1);
...
static PyObject *__pyx_pf_15gkdt_pydensecrf_10PyDenseCRF_2inference(struct __pyx_obj_15gkdt_pydensecrf_PyDenseCRF *__pyx_v_self, __Pyx_memviewslice __pyx_v_unary1, __Pyx_memviewslice __pyx_v_ref, __Pyx_memviewslice __pyx_v_out1) {
 ...
 */
  ...
  __pyx_t_2 = -1;
  if (__pyx_t_1 < 0) {
    __pyx_t_1 += __pyx_v_unary1.shape[0];
    if (unlikely(__pyx_t_1 < 0)) __pyx_t_2 = 0;
  } else if (unlikely(__pyx_t_1 >= __pyx_v_unary1.shape[0])) __pyx_t_2 = 0;
  ...
  __pyx_t_2 = -1;
  if (__pyx_t_3 < 0) {
    __pyx_t_3 += __pyx_v_ref.shape[0];
    if (unlikely(__pyx_t_3 < 0)) __pyx_t_2 = 0;
  } else if (unlikely(__pyx_t_3 >= __pyx_v_ref.shape[0])) __pyx_t_2 = 0;
  if (unlikely(__pyx_t_2 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_2);
    __PYX_ERR(1, 42, __pyx_L1_error)
  }
  ...
  __pyx_t_2 = -1;
  if (__pyx_t_4 < 0) {
    __pyx_t_4 += __pyx_v_out1.shape[0];
    if (unlikely(__pyx_t_4 < 0)) __pyx_t_2 = 0;
  } else if (unlikely(__pyx_t_4 >= __pyx_v_out1.shape[0])) __pyx_t_2 = 0;
  if (unlikely(__pyx_t_2 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_2);
    __PYX_ERR(1, 42, __pyx_L1_error)
  }
  try {
    __pyx_v_self->dcrf->inference((&(*((float *) ( /* dim=0 */ (__pyx_v_unary1.data + __pyx_t_1 * __pyx_v_unary1.strides[0]) )))), (&(*((float *) ( /* dim=0 */ (__pyx_v_ref.data + __pyx_t_3 * __pyx_v_ref.strides[0]) )))), (&(*((float *) ( /* dim=0 */ (__pyx_v_out1.data + __pyx_t_4 * __pyx_v_out1.strides[0]) )))));
  } catch(...) {
    __Pyx_CppExn2PyErr();
    __PYX_ERR(1, 42, __pyx_L1_error)
  }
 ...
 */
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_unary1, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_ref, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_out1, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}

/* "gkdt_pydensecrf.pyx":44
 *         self.dcrf.inference(&unary1[0], &ref[0], &out1[0])
 * 
 *     def __dealloc__(self):             # <<<<<<<<<<<<<<
 *         del self.dcrf
...
/* Python wrapper */
static void __pyx_pw_15gkdt_pydensecrf_10PyDenseCRF_5__dealloc__(PyObject *__pyx_v_self); /*proto*/
static void __pyx_pw_15gkdt_pydensecrf_10PyDenseCRF_5__dealloc__(PyObject *__pyx_v_self) {
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__dealloc__ (wrapper)", 0);
  __pyx_pf_15gkdt_pydensecrf_10PyDenseCRF_4__dealloc__(((struct __pyx_obj_15gkdt_pydensecrf_PyDenseCRF *)__pyx_v_self));

  /* function exit code */
  __Pyx_RefNannyFinishContext();
}

static void __pyx_pf_15gkdt_pydensecrf_10PyDenseCRF_4__dealloc__(struct __pyx_obj_15gkdt_pydensecrf_PyDenseCRF *__pyx_v_self) {
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__dealloc__", 0);

  /* "gkdt_pydensecrf.pyx":45
 * 
 *     def __dealloc__(self):
 *         del self.dcrf             # <<<<<<<<<<<<<<
 */
  delete __pyx_v_self->dcrf;
...
/* Python wrapper */
static PyObject *__pyx_pw_15gkdt_pydensecrf_10PyDenseCRF_7__reduce_cython__(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_pw_15gkdt_pydensecrf_10PyDenseCRF_7__reduce_cython__(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__reduce_cython__ (wrapper)", 0);
  __pyx_r = __pyx_pf_15gkdt_pydensecrf_10PyDenseCRF_6__reduce_cython__(((struct __pyx_obj_15gkdt_pydensecrf_PyDenseCRF *)__pyx_v_self));
...
static PyObject *__pyx_pf_15gkdt_pydensecrf_10PyDenseCRF_6__reduce_cython__(CYTHON_UNUSED struct __pyx_obj_15gkdt_pydensecrf_PyDenseCRF *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
 ...
 */
  ...
  __Pyx_AddTraceback("gkdt_pydensecrf.PyDenseCRF.__reduce_cython__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
/* Python wrapper */
static PyObject *__pyx_pw_15gkdt_pydensecrf_10PyDenseCRF_9__setstate_cython__(PyObject *__pyx_v_self, PyObject *__pyx_v___pyx_state); /*proto*/
static PyObject *__pyx_pw_15gkdt_pydensecrf_10PyDenseCRF_9__setstate_cython__(PyObject *__pyx_v_self, PyObject *__pyx_v___pyx_state) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__setstate_cython__ (wrapper)", 0);
  __pyx_r = __pyx_pf_15gkdt_pydensecrf_10PyDenseCRF_8__setstate_cython__(((struct __pyx_obj_15gkdt_pydensecrf_PyDenseCRF *)__pyx_v_self), ((PyObject *)__pyx_v___pyx_state));
...
static PyObject *__pyx_pf_15gkdt_pydensecrf_10PyDenseCRF_8__setstate_cython__(CYTHON_UNUSED struct __pyx_obj_15gkdt_pydensecrf_PyDenseCRF *__pyx_v_self, CYTHON_UNUSED PyObject *__pyx_v___pyx_state) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
 ...
 */
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_AddTraceback("gkdt_pydensecrf.PyDenseCRF.__setstate_cython__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
static PyObject *__pyx_tp_new_15gkdt_pydensecrf_PyDenseCRF(PyTypeObject *t, PyObject *a, PyObject *k) {
  PyObject *o;
  ...
  if (unlikely(__pyx_pw_15gkdt_pydensecrf_10PyDenseCRF_1__cinit__(o, a, k) < 0)) goto bad;
  return o;
  bad:
  Py_DECREF(o); o = 0;
  return NULL;
...
static void __pyx_tp_dealloc_15gkdt_pydensecrf_PyDenseCRF(PyObject *o) {
  ...
  #endif
  {
    ...
    __pyx_pw_15gkdt_pydensecrf_10PyDenseCRF_5__dealloc__(o);
    __Pyx_SET_REFCNT(o, Py_REFCNT(o) - 1);
...
static PyMethodDef __pyx_methods_15gkdt_pydensecrf_PyDenseCRF[] = {
  {"inference", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_15gkdt_pydensecrf_10PyDenseCRF_3inference, METH_VARARGS|METH_KEYWORDS, 0},
  {"__reduce_cython__", (PyCFunction)__pyx_pw_15gkdt_pydensecrf_10PyDenseCRF_7__reduce_cython__, METH_NOARGS, 0},
  {"__setstate_cython__", (PyCFunction)__pyx_pw_15gkdt_pydensecrf_10PyDenseCRF_9__setstate_cython__, METH_O, 0},
  {0, 0, 0, 0}
};

static PyTypeObject __pyx_type_15gkdt_pydensecrf_PyDenseCRF = {
  PyVarObject_HEAD_INIT(0, 0)
  "gkdt_pydensecrf.PyDenseCRF", /*tp_name*/
  sizeof(struct __pyx_obj_15gkdt_pydensecrf_PyDenseCRF), /*tp_basicsize*/
  0, /*tp_itemsize*/
  __pyx_tp_dealloc_15gkdt_pydensecrf_PyDenseCRF, /*tp_dealloc*/
  ...
  0, /*tp_iter*/
  0, /*tp_iternext*/
  __pyx_methods_15gkdt_pydensecrf_PyDenseCRF, /*tp_methods*/
  0, /*tp_members*/
  0, /*tp_getset*/
  0, /*tp_base*/
  0, /*tp_dict*/
  ...
  0, /*tp_init*/
  0, /*tp_alloc*/
  __pyx_tp_new_15gkdt_pydensecrf_PyDenseCRF, /*tp_new*/
  0, /*tp_free*/
  0, /*tp_is_gc*/
  0, /*tp_bases*/
  0, /*tp_mro*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "gkdt_pydensecrf.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "gkdt_pydensecrf._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_gkdt_pydensecrf(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_gkdt_pydensecrf},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_PyDenseCRF, __pyx_k_PyDenseCRF, sizeof(__pyx_k_PyDenseCRF), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_bilateral_compat, __pyx_k_bilateral_compat, sizeof(__pyx_k_bilateral_compat), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_d_bifeats, __pyx_k_d_bifeats, sizeof(__pyx_k_d_bifeats), 0, 0, 1, 1},
  {&__pyx_n_s_d_spfeats, __pyx_k_d_spfeats, sizeof(__pyx_k_d_spfeats), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_spatial_compat, __pyx_k_spatial_compat, sizeof(__pyx_k_spatial_compat), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_theta_alpha, __pyx_k_theta_alpha, sizeof(__pyx_k_theta_alpha), 0, 0, 1, 1},
  {&__pyx_n_s_theta_beta, __pyx_k_theta_beta, sizeof(__pyx_k_theta_beta), 0, 0, 1, 1},
  {&__pyx_n_s_theta_gamma, __pyx_k_theta_gamma, sizeof(__pyx_k_theta_gamma), 0, 0, 1, 1},
  {&__pyx_kp_s_unable_to_allocate_array_data, __pyx_k_unable_to_allocate_array_data, sizeof(__pyx_k_unable_to_allocate_array_data), 0, 0, 1, 0},
  {&__pyx_kp_s_unable_to_allocate_shape_and_str, __pyx_k_unable_to_allocate_shape_and_str, sizeof(__pyx_k_unable_to_allocate_shape_and_str), 0, 0, 1, 0},
  {&__pyx_n_s_unary1, __pyx_k_unary1, sizeof(__pyx_k_unary1), 0, 0, 1, 1},
...
static int __Pyx_modinit_type_init_code(void) {
  ...
  /*--- Type init code ---*/
  if (PyType_Ready(&__pyx_type_15gkdt_pydensecrf_PyDenseCRF) < 0) __PYX_ERR(1, 21, __pyx_L1_error)
  #if PY_VERSION_HEX < 0x030800B1
  __pyx_type_15gkdt_pydensecrf_PyDenseCRF.tp_print = 0;
  #endif
  if ((CYTHON_USE_TYPE_SLOTS && CYTHON_USE_PYTYPE_LOOKUP) && likely(!__pyx_type_15gkdt_pydensecrf_PyDenseCRF.tp_dictoffset && __pyx_type_15gkdt_pydensecrf_PyDenseCRF.tp_getattro == PyObject_GenericGetAttr)) {
    __pyx_type_15gkdt_pydensecrf_PyDenseCRF.tp_getattro = __Pyx_PyObject_GenericGetAttr;
  }
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s_PyDenseCRF, (PyObject *)&__pyx_type_15gkdt_pydensecrf_PyDenseCRF) < 0) __PYX_ERR(1, 21, __pyx_L1_error)
  if (__Pyx_setup_reduce((PyObject*)&__pyx_type_15gkdt_pydensecrf_PyDenseCRF) < 0) __PYX_ERR(1, 21, __pyx_L1_error)
  __pyx_ptype_15gkdt_pydensecrf_PyDenseCRF = &__pyx_type_15gkdt_pydensecrf_PyDenseCRF;
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initgkdt_pydensecrf(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initgkdt_pydensecrf(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_gkdt_pydensecrf(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_gkdt_pydensecrf(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_gkdt_pydensecrf(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'gkdt_pydensecrf' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_gkdt_pydensecrf(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("gkdt_pydensecrf", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_gkdt_pydensecrf) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(1, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(1, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "gkdt_pydensecrf")) {
      if (unlikely(PyDict_SetItemString(modules, "gkdt_pydensecrf", __pyx_m) < 0)) __PYX_ERR(1, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init gkdt_pydensecrf", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init gkdt_pydensecrf");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
